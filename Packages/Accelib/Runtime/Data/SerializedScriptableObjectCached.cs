...
{
    public abstract class SerializedScriptableObjectCached<T> : SerializedScriptableObject, IPreviewNameProvider, IPreviewIconProvider where T : SerializedScriptableObject
    {
